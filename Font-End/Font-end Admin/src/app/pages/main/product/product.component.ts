...
// import { B10Product} from '../../../shared/models/B10Product';
...
//     this.listItem = new PagedResult<B10Product>();
//     this.groupData = new GroupData();
//     this.selectItem = new B10Product();
//   }

...
@Component({
  ...
  templateUrl: './acc-doc-purchasae.component.html',
  styleUrls: ['./acc-doc-purchasae.component.css']
})
export class AccDoc_PurchaseComponent extends BaseComponent implements OnInit {
  //exploredata
  public tintuc: any;
  public page = 1;
  ...
  constructor(private fb: FormBuilder, private httpclient: HttpClient, injector: Injector, private route: ActivatedRoute, private router: Router) {
    ...
    this.listItem = new PagedResult<vB20AccDoc_Purchase>();
    this.selectItem = new vB20AccDoc_Purchase();
  }
  ...
  showAdd()
  {
    this.router.navigate(['/acc-doc-purchase-edit']);
  }
 
  showEdit(item)
  {
    debugger;
    this.router.navigate(['/acc-doc-purchase-edit/'+item]);
  }
  Delete(id: number) {

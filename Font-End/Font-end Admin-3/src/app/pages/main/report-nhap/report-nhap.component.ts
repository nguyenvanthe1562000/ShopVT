...
@Component({
  selector: 'app-report-nhap',
  templateUrl: './report-nhap.component.html',
  styleUrls: ['./report-nhap.component.css']
})
export class ReportNhapComponent extends BaseComponent implements OnInit {
  //exploredata
  public tintuc: any;
  public page = 1;
  public pageSize = 20;
  ...
  search(form: NgForm) {
    this._api.post(`${this.api}/ban-chay`, form.value).takeUntil(this.unsubscribe).subscribe(res => {
      this.listItem = res;
    });
  }

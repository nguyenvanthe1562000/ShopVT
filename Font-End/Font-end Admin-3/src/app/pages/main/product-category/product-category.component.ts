...
export class ProductCategoryComponent extends BaseComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private httpclient: HttpClient, injector: Injector, private route: ActivatedRoute, private router: Router) {
    ...
    this.listItem = new PagedResult<B10ProductCategory>();
    this.groupData = new GroupData();
    this.selectItem = new B10ProductCategory();
  }
  ...
  Update(form: NgForm, addType: number) {
    ...
    this.selectItem.b10ProductCategoryInf_Json = this.fieldArray;
  ...
  GetById(id: number) {   
      this._api.get(`${this.api}/${id}`,).takeUntil(this.unsubscribe).subscribe(res => {
        ...
        this.selectItem.b10ProductCategoryInf_Json=res.b10ProductCategoryInf_Json;
       
        this.fieldArray = this.selectItem.b10ProductCategoryInf_Json;

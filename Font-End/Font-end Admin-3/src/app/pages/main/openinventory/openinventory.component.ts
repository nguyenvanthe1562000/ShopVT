...
import { vB20OpenInventory } from '../../../shared/models/vB20OpenInventory';
...
@Component({
  selector: 'app-openinventory',
  templateUrl: './openinventory.component.html',
  styleUrls: ['./openinventory.component.css']
})
export class OpeninventoryComponent extends BaseComponent implements OnInit {
  ...
  public selectItemForeignKey:any;
  ...
  constructor(private fb: FormBuilder, private httpclient: HttpClient, injector: Injector, private route: ActivatedRoute, private router: Router) {
    ...
    this.listItem = new PagedResult<vB20OpenInventory>();
    this.groupData = new GroupData();
    this.selectItem=new vB20OpenInventory();
  }

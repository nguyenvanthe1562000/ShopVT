...
import { B20AccDocProduct } from 'src/app/shared/models/B20AccDocProduct';
...
@Component({
  selector: 'app-acc-doc-product',
  templateUrl: './acc-doc-product.component.html',
  styleUrls: ['./acc-doc-product.component.css']
})
export class AccDocProductComponent extends BaseComponent implements OnInit {
  //exploredata
  public tintuc: any;
  public page = 1;
  public pageSize = 20;
  ...
  public listItem: PagedResult<B20AccDocProduct>;
  public checkFilter: boolean;
  public ClickColumn: string = '';
  public api: string = '/api/accdoc-product' ;
  public groupData: GroupData;
  public selectGroup: any;
  public selectItem: B20AccDocProduct;
  ...
  constructor(private fb: FormBuilder, private httpclient: HttpClient, injector: Injector, private route: ActivatedRoute, private router: Router) {
    ...
    this.listItem = new PagedResult<B20AccDocProduct>();
  
    this.selectItem = new B20AccDocProduct();
  }
  ...
  SelectForeignKey(event:any,foreignKey: string)
  {
    ...
    this.newAttribute.imagePath = event.image;
  }
  //grid
  ...
  Add(form: NgForm, addDataIsGroup: boolean, addType: number) {
    ...
    let obj:B20AccDocProduct = new B20AccDocProduct();
    this.ConvertNgFormToFormData(form,this.formData);

    this.formData.append('vB20AccDocProductDetail', JSON.stringify(this.fieldArray));
  ...
  Update(form: NgForm, addType: number) {
    ...
    this.selectItem.vB20AccDocProductDetail_Json = this.fieldArray;
    this.formData.append('vB20AccDocProductDetail', JSON.stringify(this.fieldArray));
  ...
  GetById(id: number) {   
    debugger;
      this._api.get(`${this.api}/${id}`,).takeUntil(this.unsubscribe).subscribe(res => {
        ...
        this.selectItem.vB20AccDocProductDetail_Json=res.vB20AccDocProductDetail_Json;
       
        this.fieldArray = this.selectItem.vB20AccDocProductDetail_Json;

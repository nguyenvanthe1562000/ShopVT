...
@Component({
  selector: 'app-report-xuat',
  templateUrl: './report-xuat.component.html',
  styleUrls: ['./report-xuat.component.css']
})
export class ReportXuatComponent extends BaseComponent implements OnInit {
  //exploredata
  public tintuc: any;
  public page = 1;
  public pageSize = 20;

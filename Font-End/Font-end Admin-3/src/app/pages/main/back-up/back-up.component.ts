...
export class BackUpComponent extends BaseComponent implements OnInit {
  //exploredata
  public tintuc: any;
  public page = 1;
  public pageSize = 20;
  ...
  showAdd() {
    this._api.put(`${this.api}/back-up`,{}).takeUntil(this.unsubscribe).subscribe(res => {
      alert(res);
    });
  }
  showEdit(item: any) {
